...
class MosaicHttp extends Http_1.Http {
    ...
    getMosaic(mosaicId) {
        return this.getNetworkTypeObservable().pipe(operators_1.mergeMap((networkType) => rxjs_1.from(this.mosaicRoutesApi.getMosaic(mosaicId.toHex())).pipe(operators_1.map((mosaicInfoDTO) => {
            return new MosaicInfo_1.MosaicInfo(mosaicInfoDTO.meta.id, new MosaicId_1.MosaicId(mosaicInfoDTO.mosaic.mosaicId), new UInt64_1.UInt64(mosaicInfoDTO.mosaic.supply), new UInt64_1.UInt64(mosaicInfoDTO.mosaic.height), PublicAccount_1.PublicAccount.createFromPublicKey(mosaicInfoDTO.mosaic.owner, networkType), mosaicInfoDTO.mosaic.revision, new MosaicProperties_1.MosaicProperties(new UInt64_1.UInt64(mosaicInfoDTO.mosaic.properties[MosaicPropertyType_1.MosaicPropertyType.MosaicFlags].value), (new UInt64_1.UInt64(mosaicInfoDTO.mosaic.properties[MosaicPropertyType_1.MosaicPropertyType.Divisibility].value)).compact(), new UInt64_1.UInt64(mosaicInfoDTO.mosaic.properties[MosaicPropertyType_1.MosaicPropertyType.Duration].value)));
        }))));
    }
    /**
