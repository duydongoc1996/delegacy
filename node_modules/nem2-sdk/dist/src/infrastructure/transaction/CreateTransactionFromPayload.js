...
const CreateTransaction = (type, transactionData, networkType, deadline) => {
    switch (type) {
        ...
        case TransactionType_1.TransactionType.MODIFY_ACCOUNT_PROPERTY_MOSAIC:
            ...
            switch (type) {
                case TransactionType_1.TransactionType.MODIFY_ACCOUNT_PROPERTY_ADDRESS:
                    const t = ModifyAccountPropertyAddressTransaction_1.ModifyAccountPropertyAddressTransaction.create(Deadline_1.Deadline.createFromDTO(deadline), parseInt(nem2_library_1.convert.uint8ToHex(nem2_library_1.convert.hexToUint8(propertyType).reverse()), 16), modificationArray ? modificationArray.map((modification) => new AccountPropertyModification_1.AccountPropertyModification(parseInt(nem2_library_1.convert.uint8ToHex(nem2_library_1.convert.hexToUint8(modification.substring(0, 2)).reverse()), 16), Address_1.Address.createFromEncoded(modification.substring(2, modification.length)).plain())) : [], networkType);
                    return t;
                case TransactionType_1.TransactionType.MODIFY_ACCOUNT_PROPERTY_MOSAIC:
                    return ModifyAccountPropertyMosaicTransaction_1.ModifyAccountPropertyMosaicTransaction.create(Deadline_1.Deadline.createFromDTO(deadline), parseInt(nem2_library_1.convert.uint8ToHex(nem2_library_1.convert.hexToUint8(propertyType).reverse()), 16), modificationArray ? modificationArray.map((modification) => new AccountPropertyModification_1.AccountPropertyModification(parseInt(nem2_library_1.convert.uint8ToHex(nem2_library_1.convert.hexToUint8(modification.substring(0, 2)).reverse()), 16), UInt64_1.UInt64.fromHex(reverse(modification.substring(2, modification.length))).toDTO())) : [], networkType);
                case TransactionType_1.TransactionType.MODIFY_ACCOUNT_PROPERTY_ENTITY_TYPE:
                    return ModifyAccountPropertyEntityTypeTransaction_1.ModifyAccountPropertyEntityTypeTransaction.create(Deadline_1.Deadline.createFromDTO(deadline), parseInt(nem2_library_1.convert.uint8ToHex(nem2_library_1.convert.hexToUint8(propertyType).reverse()), 16), modificationArray ? modificationArray.map((modification) => new AccountPropertyModification_1.AccountPropertyModification(parseInt(nem2_library_1.convert.uint8ToHex(nem2_library_1.convert.hexToUint8(modification.substring(0, 2)).reverse()), 16), parseInt(nem2_library_1.convert.uint8ToHex(nem2_library_1.convert.hexToUint8(modification.substring(2, modification.length)).reverse()), 16))) : [], networkType);
            }
        ...
        case TransactionType_1.TransactionType.LINK_ACCOUNT:
            ...
            return AccountLinkTransaction_1.AccountLinkTransaction.create(Deadline_1.Deadline.createFromDTO(deadline), remoteAccountKey, parseInt(nem2_library_1.convert.uint8ToHex(nem2_library_1.convert.hexToUint8(linkAction).reverse()), 16), networkType);
        case TransactionType_1.TransactionType.ADDRESS_ALIAS:
            ...
            return AddressAliasTransaction_1.AddressAliasTransaction.create(Deadline_1.Deadline.createFromDTO(deadline), parseInt(nem2_library_1.convert.uint8ToHex(nem2_library_1.convert.hexToUint8(addressAliasAction).reverse()), 16), new NamespaceId_1.NamespaceId(UInt64_1.UInt64.fromHex(reverse(addressAliasNamespaceId)).toDTO()), Address_1.Address.createFromEncoded(addressAliasAddress), networkType);
        case TransactionType_1.TransactionType.MOSAIC_ALIAS:
            ...
            return MosaicAliasTransaction_1.MosaicAliasTransaction.create(Deadline_1.Deadline.createFromDTO(deadline), parseInt(nem2_library_1.convert.uint8ToHex(nem2_library_1.convert.hexToUint8(mosaicAliasAction).reverse()), 16), new NamespaceId_1.NamespaceId(UInt64_1.UInt64.fromHex(reverse(mosaicAliasNamespaceId)).toDTO()), new MosaicId_1.MosaicId(UInt64_1.UInt64.fromHex(reverse(mosaicAliasMosaicId)).toDTO()), networkType);
        case TransactionType_1.TransactionType.MOSAIC_DEFINITION:
            ...
            const flags = parseInt(nem2_library_1.convert.uint8ToHex(nem2_library_1.convert.hexToUint8(transactionData.substring(flagsOffset, divisibilityOffset)).reverse()), 16);
            ...
            const nonceArray = regexArray ? regexArray.map((n) => {
                return parseInt(nem2_library_1.convert.uint8ToHex(nem2_library_1.convert.hexToUint8(n).reverse()), 16);
            }) : [];
            return MosaicDefinitionTransaction_1.MosaicDefinitionTransaction.create(Deadline_1.Deadline.createFromDTO(deadline), new MosaicNonce_1.MosaicNonce(new Uint8Array(nonceArray)), new MosaicId_1.MosaicId(UInt64_1.UInt64.fromHex(reverse(mosaicId)).toDTO()), MosaicProperties_1.MosaicProperties.create({
                ...
                divisibility: parseInt(nem2_library_1.convert.uint8ToHex(nem2_library_1.convert.hexToUint8(divisibility).reverse()), 16),
        ...
        case TransactionType_1.TransactionType.MOSAIC_SUPPLY_CHANGE:
            ...
            return MosaicSupplyChangeTransaction_1.MosaicSupplyChangeTransaction.create(Deadline_1.Deadline.createFromDTO(deadline), new MosaicId_1.MosaicId(UInt64_1.UInt64.fromHex(reverse(mosaicSupMosaicId)).toDTO()), parseInt(nem2_library_1.convert.uint8ToHex(nem2_library_1.convert.hexToUint8(mosaicSupDirection).reverse()), 16), UInt64_1.UInt64.fromHex(reverse(delta)), networkType);
        case TransactionType_1.TransactionType.REGISTER_NAMESPACE:
            // read bytes
            const namespaceType = parseInt(nem2_library_1.convert.uint8ToHex(nem2_library_1.convert.hexToUint8(transactionData.substring(0, 2)).reverse()), 16);
        ...
        case TransactionType_1.TransactionType.TRANSFER:
            ...
            const transferMessageSize = parseInt(nem2_library_1.convert.uint8ToHex(nem2_library_1.convert.hexToUint8(transactionData.substring(50, 54)).reverse()), 16);
            const transferMessageAndMosaicSubString = transactionData.substring(56);
            const transferMessageType = parseInt(nem2_library_1.convert.uint8ToHex(nem2_library_1.convert.hexToUint8(transferMessageAndMosaicSubString.substring(0, 2)).reverse()), 16);
        ...
        case TransactionType_1.TransactionType.SECRET_LOCK:
            ...
            const secretLockHashAlgorithm = parseInt(nem2_library_1.convert.uint8ToHex(nem2_library_1.convert.hexToUint8(transactionData.substring(48, 50)).reverse()), 16);
        ...
        case TransactionType_1.TransactionType.SECRET_PROOF:
            // read bytes
            const secretProofHashAlgorithm = parseInt(nem2_library_1.convert.uint8ToHex(nem2_library_1.convert.hexToUint8(transactionData.substring(0, 2)).reverse()), 16);
        ...
        case TransactionType_1.TransactionType.MODIFY_MULTISIG_ACCOUNT:
            // read bytes
            const minRemovalDelta = parseInt(nem2_library_1.convert.uint8ToHex(nem2_library_1.convert.hexToUint8(transactionData.substring(0, 2)).reverse()), 16);
            const minApprovalDelta = parseInt(nem2_library_1.convert.uint8ToHex(nem2_library_1.convert.hexToUint8(transactionData.substring(2, 4)).reverse()), 16);
            const modificationsCount = parseInt(nem2_library_1.convert.uint8ToHex(nem2_library_1.convert.hexToUint8(transactionData.substring(4, 6)).reverse()), 16);
        ...
        case TransactionType_1.TransactionType.AGGREGATE_COMPLETE:
            // read bytes
            const payloadSize = parseInt(nem2_library_1.convert.uint8ToHex(nem2_library_1.convert.hexToUint8(transactionData.substring(0, 8)).reverse()), 16) * 2;
        ...
        case TransactionType_1.TransactionType.AGGREGATE_BONDED:
            const bondedPayloadSize = parseInt(nem2_library_1.convert.uint8ToHex(nem2_library_1.convert.hexToUint8(transactionData.substring(0, 8)).reverse()), 16) * 2;
...
const extractTransactionTypeFromHex = (hexValue) => {
    return parseInt(nem2_library_1.convert.uint8ToHex(nem2_library_1.convert.hexToUint8(hexValue).reverse()), 16);
};
/**
 * @internal
...
const extractNetwork = (versionHex) => {
    const networkType = nem2_library_1.convert.hexToUint8(versionHex)[1];
 ...
 */
const reverse = (hex) => {
    return nem2_library_1.convert.uint8ToHex(nem2_library_1.convert.hexToUint8(hex).reverse());
};
/**
 * @internal
...
const parseInnerTransactionFromBinary = (innerTransactionBinary) => {
    ...
    while (innerBinary.length) {
        const payloadSize = parseInt(nem2_library_1.convert.uint8ToHex(nem2_library_1.convert.hexToUint8(innerBinary.substring(0, 8)).reverse()), 16) * 2;
