...
class BlockHttp extends Http_1.Http {
    ...
    constructor(url, networkHttp) {
        ...
        this.blockRoutesApi = new nem2_library_1.BlockRoutesApi(this.apiClient);
    }
    /**
    ...
    getBlockTransactions(height, queryParams) {
        return rxjs_1.from(this.blockRoutesApi.getBlockTransactions(height, queryParams != null ? queryParams : {})).pipe(operators_1.map((transactionsDTO) => {
