...
var _NetworkTypeEnum = require('./NetworkTypeEnum');

var _NetworkTypeEnum2 = _interopRequireDefault(_NetworkTypeEnum);
...
var BlockDTO = function () {
    ...
    */
    ...
    function BlockDTO(signature, signer, version, type, height, timestamp, difficulty, feeMultiplier, previousBlockHash, blockTransactionsHash, blockReceiptsHash, stateHash, beneficiary) {
        ...
        value: function constructFromObject(data, obj) {
            if (data) {
                ...
                if (data.hasOwnProperty('version')) {
                    obj['version'] = _NetworkTypeEnum2.default.constructFromObject(data['version']);
                }
                ...
                if (data.hasOwnProperty('beneficiary')) {
                    obj['beneficiary'] = _ApiClient2.default.convertToType(data['beneficiary'], 'String');
                }
            }
            return obj;
        }
