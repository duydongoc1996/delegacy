...
var _AliasTypeEnum = require('./AliasTypeEnum');

var _AliasTypeEnum2 = _interopRequireDefault(_AliasTypeEnum);
        ...
        value: function constructFromObject(data, obj) {
            if (data) {
                ...
                if (data.hasOwnProperty('type')) {
                    obj['type'] = _AliasTypeEnum2.default.constructFromObject(data['type']);
                }
