...
var _RolesTypeEnum = require('./RolesTypeEnum');

var _RolesTypeEnum2 = _interopRequireDefault(_RolesTypeEnum);
        ...
        value: function constructFromObject(data, obj) {
            if (data) {
                ...
                if (data.hasOwnProperty('roles')) {
                    obj['roles'] = _RolesTypeEnum2.default.constructFromObject(data['roles']);
                }
