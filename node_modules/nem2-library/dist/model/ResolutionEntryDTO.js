...
var _SourceDTO = require('./SourceDTO');

var _SourceDTO2 = _interopRequireDefault(_SourceDTO);
...
* @version 0.7.15
*/
var ResolutionEntryDTO = function () {
    /**
    ...
    */
    ...
    function ResolutionEntryDTO(source, resolved) {
        _classCallCheck(this, ResolutionEntryDTO);
    ...
    */
    ...
    _createClass(ResolutionEntryDTO, null, [{
        ...
        value: function constructFromObject(data, obj) {
            if (data) {
                ...
                if (data.hasOwnProperty('source')) {
                    obj['source'] = _SourceDTO2.default.constructFromObject(data['source']);
                }
                if (data.hasOwnProperty('resolved')) {
                    obj['resolved'] = _UInt64DTO2.default.constructFromObject(data['resolved']);
                }
            }
            return obj;
        }
...
exports.default = ResolutionEntryDTO;
//# sourceMappingURL=ResolutionEntryDTO.js.map