...
var SourceDTO = function () {
    ...
    */
    ...
    function SourceDTO(primaryId, secondaryId) {
        _classCallCheck(this, SourceDTO);
        ...
        value: function constructFromObject(data, obj) {
            if (data) {
                ...
                if (data.hasOwnProperty('primaryId')) {
                    obj['primaryId'] = _ApiClient2.default.convertToType(data['primaryId'], 'Number');
                }
                if (data.hasOwnProperty('secondaryId')) {
                    obj['secondaryId'] = _ApiClient2.default.convertToType(data['secondaryId'], 'Number');
                }
            }
            return obj;
        }
