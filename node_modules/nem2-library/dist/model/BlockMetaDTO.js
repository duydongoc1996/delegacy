...
var BlockMetaDTO = function () {
    ...
    */
    ...
    function BlockMetaDTO(hash, generationHash, subCacheMerkleRoots, totalFee, numTransactions) {
        _classCallCheck(this, BlockMetaDTO);

        this.hash = undefined;
        this.generationHash = undefined;
        this.subCacheMerkleRoots = undefined;
        this.totalFee = undefined;
        this.numTransactions = undefined;
        this.numStatements = undefined;
        ...
        value: function constructFromObject(data, obj) {
            if (data) {
                ...
                if (data.hasOwnProperty('subCacheMerkleRoots')) {
                    obj['subCacheMerkleRoots'] = _ApiClient2.default.convertToType(data['subCacheMerkleRoots'], ['String']);
                }
                ...
                if (data.hasOwnProperty('numStatements')) {
                    obj['numStatements'] = _ApiClient2.default.convertToType(data['numStatements'], 'Number');
                }
            }
            return obj;
        }
