...
var _NamespaceTypeEnum = require('./NamespaceTypeEnum');

var _NamespaceTypeEnum2 = _interopRequireDefault(_NamespaceTypeEnum);
...
var NamespaceDTO = function () {
    ...
    */
    ...
    function NamespaceDTO(owner, ownerAddress, startHeight, endHeight, depth, level0, type, alias, parentId) {
        ...
        value: function constructFromObject(data, obj) {
            if (data) {
                ...
                if (data.hasOwnProperty('type')) {
                    obj['type'] = _NamespaceTypeEnum2.default.constructFromObject(data['type']);
                }
