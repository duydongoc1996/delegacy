...
var _MosaicPropertyDTO = require('./MosaicPropertyDTO');

var _MosaicPropertyDTO2 = _interopRequireDefault(_MosaicPropertyDTO);
        ...
        value: function constructFromObject(data, obj) {
            if (data) {
                ...
                if (data.hasOwnProperty('properties')) {
                    obj['properties'] = _ApiClient2.default.convertToType(data['properties'], [_MosaicPropertyDTO2.default]);
                }
