...
var _AccountDTO = require('./AccountDTO');

var _AccountDTO2 = _interopRequireDefault(_AccountDTO);

var _AccountMetaDTO = require('./AccountMetaDTO');
...
var AccountInfoDTO = function () {
    ...
    */
    ...
    function AccountInfoDTO(meta, account) {
        _classCallCheck(this, AccountInfoDTO);
    ...
    */
    ...
    _createClass(AccountInfoDTO, null, [{
        ...
        value: function constructFromObject(data, obj) {
            if (data) {
                ...
                if (data.hasOwnProperty('meta')) {
                    obj['meta'] = _AccountMetaDTO2.default.constructFromObject(data['meta']);
                }
                if (data.hasOwnProperty('account')) {
                    obj['account'] = _AccountDTO2.default.constructFromObject(data['account']);
                }
            }
            return obj;
        }
...
exports.default = AccountInfoDTO;
