...
var AggregateTransaction = function (_VerifiableTransactio) {
	...
	_createClass(AggregateTransaction, [{
		...
		value: function signTransactionWithCosigners(initializer, cosigners, generationHash) {
			var signedTransaction = this.signTransaction(initializer, generationHash);
		...
		value: function signTransactionGivenSignatures(initializer, cosignedSignedTransactions, generationHash) {
			var signedTransaction = this.signTransaction(initializer, generationHash);
