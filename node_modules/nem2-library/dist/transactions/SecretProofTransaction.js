			...
			var Builder = function () {
				...
				_createClass(Builder, [{
					...
					value: function build() {
						...
						var byteSecret = _convert2.default.hexToUint8(64 > this.secret.length ? this.secret + '0'.repeat(64 - this.secret.length) : this.secret);
						var secretVector = SecretProofTransactionBuffer.createSecretVector(builder, byteSecret);
						var recipientVector = SecretProofTransactionBuffer.createRecipientVector(builder, this.recipient);
