...
var VerifiableTransaction = function () {
  ...
  */
   ...
   */
		value: function signTransaction(keyPair, generationHash) {
			var generationHashBytes = Array.from(_convert2.default.hexToUint8(generationHash));
			var byteBuffer = this.serialize();
			var signingBytes = generationHashBytes.concat(byteBuffer.slice(4 + 64 + 32));
   ...
   */
		...
		value: function createTransactionHash(transactionPayload, generationHash) {
			var byteBuffer = Array.from(_convert2.default.hexToUint8(transactionPayload));
			var signingBytes = byteBuffer.slice(4, 36).concat(byteBuffer.slice(4 + 64, 4 + 64 + 32)).concat(generationHash).concat(byteBuffer.splice(4 + 64 + 32, byteBuffer.length));
