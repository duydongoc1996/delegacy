...
var NamespaceRoutesApi = function () {
  ...
  */
  ...
  _createClass(NamespaceRoutesApi, [{
    ...
    value: function getNamespacesFromAccountsWithHttpInfo(accountsIds, opts) {
      opts = opts || {};
    ...
    value: function getNamespacesFromAccounts(accountsIds, opts) {
      return this.getNamespacesFromAccountsWithHttpInfo(accountsIds, opts).then(function (response_and_data) {
        return response_and_data.data;
      });
    }
    ...
    value: function getNamespacesNamesWithHttpInfo(accountsIds) {
      var postBody = accountsIds;
    ...
    value: function getNamespacesNames(accountsIds) {
      return this.getNamespacesNamesWithHttpInfo(accountsIds).then(function (response_and_data) {
        return response_and_data.data;
      });
    }
  }]);
