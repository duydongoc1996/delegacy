...
var _HeightInfoDTO = require('../model/HeightInfoDTO');

var _HeightInfoDTO2 = _interopRequireDefault(_HeightInfoDTO);
...
var ChainRoutesApi = function () {
  ...
  */
  function ChainRoutesApi(apiClient) {
    _classCallCheck(this, ChainRoutesApi);
  ...
  _createClass(ChainRoutesApi, [{
    ...
    value: function getBlockchainHeightWithHttpInfo() {
      ...
      var returnType = _HeightInfoDTO2.default;
...
exports.default = ChainRoutesApi;
