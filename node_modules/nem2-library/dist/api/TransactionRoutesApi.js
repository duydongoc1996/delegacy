...
var TransactionRoutesApi = function () {
  ...
  */
  ...
  _createClass(TransactionRoutesApi, [{
    ...
    value: function announceCosignatureTransactionWithHttpInfo(transactionPayload) {
      var postBody = transactionPayload;
      ...
      var returnType = _AnnounceTransactionInfoDTO2.default;
    ...
    value: function announceCosignatureTransaction(transactionPayload) {
      return this.announceCosignatureTransactionWithHttpInfo(transactionPayload).then(function (response_and_data) {
    ...
    value: function announcePartialTransactionWithHttpInfo(transactionPayload) {
      var postBody = transactionPayload;
    ...
    value: function announcePartialTransaction(transactionPayload) {
      return this.announcePartialTransactionWithHttpInfo(transactionPayload).then(function (response_and_data) {
        return response_and_data.data;
      });
    }
    ...
    value: function announceTransactionWithHttpInfo(transactionPayload) {
      var postBody = transactionPayload;
    ...
    value: function announceTransaction(transactionPayload) {
      return this.announceTransactionWithHttpInfo(transactionPayload).then(function (response_and_data) {
        return response_and_data.data;
      });
    }
