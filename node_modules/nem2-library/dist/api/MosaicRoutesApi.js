...
var _MosaicNamesDTO = require('../model/MosaicNamesDTO');

var _MosaicNamesDTO2 = _interopRequireDefault(_MosaicNamesDTO);
...
var MosaicRoutesApi = function () {
  ...
  */
  ...
  _createClass(MosaicRoutesApi, [{
    ...
    key: 'getMosaicsNamesWithHttpInfo',
    value: function getMosaicsNamesWithHttpInfo(mosaicIds) {
      var postBody = mosaicIds;
      ...
      var contentTypes = [];
      var accepts = ['application/json'];
      var returnType = [_MosaicNamesDTO2.default];
    ...
    key: 'getMosaicsNames',
    value: function getMosaicsNames(mosaicIds) {
      return this.getMosaicsNamesWithHttpInfo(mosaicIds).then(function (response_and_data) {
        return response_and_data.data;
      });
    }
  }]);
