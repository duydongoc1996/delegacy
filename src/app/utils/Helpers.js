...
console.log(Exchanges.data[0].address);
 ...
 */
export function haveWallet(walletName, array) {        
    let i = null;
 ...
 */
export function calcNumberOfPages(array, pageSize) {
 ...
 */
export function cleanMosaicAmounts(elem, mosaicDefinitions) {
 ...
 */
export function namespaceIsValid(ns, isParent) {
...
export function isHexadecimal() { 
    return nem.utils.helpers.isHexadecimal; 
}
 ...
 */
export function isTextAmountValid() {
    return nem.utils.helpers.isTextAmountValid;
}
 ...
 * @return {boolean} - True if valid, false otherwise
 */
export function isValidForExchanges(entity) {
 ...
 */
export function fixTimestamp(transaction, chainTime, network) {
    let d = new Date();
