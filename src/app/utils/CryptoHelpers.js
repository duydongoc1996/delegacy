...
import {generateBIP32DataLegacy} from './CryptoHelpersLegacy';
 ...
 */
export function createBIP32Data(childKey, network) {
 ...
 */
// let generateBIP32Data =
export function generateBIP32Data(privateKey, password, index, network) {
    return new Promise((resolve, reject) => {
        ...
        let childKey = generateBIP32DataLegacy(privateKey, password, index);
